...
public class TalocsHollowInstance extends GeneralInstanceHandler {
    ...
    private void addItems(Player player) {
		...
		QuestState qs3 = player.getQuestStateList().getQuestState(10032);
        QuestState qs4 = player.getQuestStateList().getQuestState(20032);
        if ((qs1 != null && qs1.getStatus() == QuestStatus.START) ||
			(qs2 != null && qs2.getStatus() == QuestStatus.START) ||
			(qs3 != null && qs3.getStatus() == QuestStatus.START) ||
