...
public class RaksangRuinsInstance extends GeneralInstanceHandler {
    ...
    private static Logger log = LoggerFactory.getLogger(RaksangRuinsInstance.class);
    ...
    private boolean wave4_done = false; //of level2
    ...
    public void onDie(Npc npc) {
        ...
        switch (npc.getNpcId()){
            ...
            case 236306: // Reviver Nasto (Boss-Middle) (Level 1 Boss || Level 2 Boss)
                switch (p.getRace()){
                    case ASMODIANS:
                        spawn(700141, 621.3292f, 684.80444f, 522.0487f, (byte) 85); // Rift (out)
                        break;
                    case ELYOS:
                        spawn(700143, 621.3292f, 684.80444f, 522.0487f, (byte) 85); // Rift (out)
                        break;
                }
                break;
        }
