 ...
 * @Aion-Core Dev.
 */
package instance.drakensphire_depth;
						...
						public void run() {
							if (score == 0) {
								...
								if (!bBuff.getEffectController().isAbnormalPresentBySkillId(21610) 
									&& !bBuff.getEffectController().isAbnormalPresentBySkillId(21611) && !bBuff.getEffectController().isAbnormalPresentBySkillId(21612)) {
									despawnNpc(bBuff);
									beritraTrue();
