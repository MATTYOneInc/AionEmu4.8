...
import com.aionemu.gameserver.controllers.EventController;
import com.aionemu.gameserver.controllers.GeoMapController;
...
import com.aionemu.gameserver.utils.stats.ServerInfo;
...
public class GameServer {
    ...
    public static void main(String[] args) {
        ...
        World.getInstance();
        GeoMapController.getInstance().checkGeoData();
        Util.printSection("===========================");
        ...
        DatabaseController.getInstance().initialized();
        Util.printSection("===========================");
        ...
        ServerInfo.getInstance().checkServerTime();
        ...
        EventController.getInstance().initialized();
        AnnouncementService.getInstance();
        DebugService.getInstance();
        WeatherService.getInstance();
        EventController.getInstance().Load();
        ...
        log.info(ServerInfo.getInstance().getInfo());
        gs.startServers();
        ...
        log.info(">>>");
        if (checkLicenseServerOnline())  log.info("+++ License Server is ONLINE");
        else							 log.info("--- License Server is OFFLINE");
        log.info(">>>");
        onStartup();
    ...
    private static void initalizeLoggger() {
        ...
        if (files != null && files.length > 0) {
            ...
            try {
                ...
                EventController.getInstance().checkEvents();
