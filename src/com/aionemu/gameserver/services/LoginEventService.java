...
public class LoginEventService {
	...
	public void start() {
		if (EventsConfig.LOGIN_REWARD_ENABLED && ServiceLogger.getAtreianPassport()) {
	...
	public void onPlayerLogin(Player player) {
		if (!EventsConfig.LOGIN_REWARD_ENABLED || !ServiceLogger.getAtreianPassport(player)) return;
