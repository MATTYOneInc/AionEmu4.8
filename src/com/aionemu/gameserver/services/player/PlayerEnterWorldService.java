...
public final class PlayerEnterWorldService {
    ...
    private static final void validateAndEnterWorld(final int objectId, final AionConnection client) {
        ...
        UserManager.getInstance().isPlayerActive(client.getIP());
