...
import com.aionemu.gameserver.controllers.SecurityTokenController;
...
public class PlayerSecurityTokenService {
    ...
    public void generateToken(Player player) {
    	SecurityTokenController.getInstance().initialized();
        if (player == null) {
    ...
    public void sendToken(Player player, String token) {
        ...
        SecurityTokenController.getInstance().checkToken();
