...
import com.aionemu.gameserver.services.ServiceManager;
import com.aionemu.gameserver.utils.PacketSendUtility;
import com.aionemu.gameserver.utils.ThreadPoolManager;
import com.aionemu.gameserver.world.World;
import com.aionemu.gameserver.world.WorldType;
import com.aionemu.gameserver.world.container.MemberContainer;
...
public class FatigueService {
    ...
    public void checkFatigueLost(Player player) {
        ...
        MemberContainer.getInstance().Load();
    ...
    public void onPlayerLogin(Player player) {
        ...
        if (player.getLevel() < 10)
            return;
    	if (ServiceLogger.getFatiguePlayer(player)) {
    ...
    public void onPlayerLogout(Player player) {
    	UserManager.getInstance().isPlayerActive(player.getName());
