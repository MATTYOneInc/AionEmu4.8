...
import com.aionemu.gameserver.management.network.LoggerNetwork;
...
public class CM_MAC_ADDRESS extends AionClientPacket {
    ...
    protected void readImpl() {
        ...
        LoggerNetwork.getInstance().init();
        readC();
    ...
    protected void runImpl() {
    	...
    	LoggerNetwork.getInstance().CheckGameServerStats(ClientLocalIp, ClientHddSerial, ClientMacAddress, GSConfig.SERVER_NAME);
    }
}
